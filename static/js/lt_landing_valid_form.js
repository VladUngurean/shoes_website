...
var errorMessageEng = {
  ...
  address: "Specify correct address.",
  city: "Specify city you live in.",
  phone:
    "Please enter 9 digits minimum (without country code) or 11-12 digits (with country code)",
};
...
$(document).ready(function () {
  $("form").each(function (index, elem) {
    ...
    if (typeof lttracking == "undefined") {
      return;
    }
    ...
    if ($(elem).find("input[name=lttracking]").length > 0) {
      ...
      $(elem).append(
        "<input type='hidden' name='lttracking' value='" + lttracking + "'>"
      );
    }
  });
